...
public class NotificationServiceConvo extends IntentService {
    ...
    public NotificationServiceConvo(String name) {
        super(name);
    }

    public NotificationServiceConvo() {
        super("SERVICE2");
    }
    ...
    protected void onHandleIntent(Intent intent2) {
        String NOTIFICATION_CHANNEL_ID = getApplicationContext().getString(R.string.title);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder.setContentTitle(getString(R.string.app_name2)).setCategory(Notification.CATEGORY_SERVICE)
