...
public class ConvocatoriaDispFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_convocatoriadisp, container, false);
    ...
    private void MostrarJson() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://192.168.174.1:8080/api/user/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        Servicios service = retrofit.create(Servicios.class);
        Call<List<Object[]>> call = service.getConvocatoriaDisp(nombr);
