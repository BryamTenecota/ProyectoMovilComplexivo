...
public class bienvenidadresponsable extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView nombreTextView = headerView.findViewById(R.id.nameRes);
        TextView apellidoTextView = headerView.findViewById(R.id.lastnameRes);
        ...
        Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content), "¡Bienvenido entró como responsable PPP!", Snackbar.LENGTH_SHORT);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_exit:
                Toast.makeText(bienvenidadresponsable.this, "", Toast.LENGTH_SHORT).show();

                AlertDialog.Builder builder = new AlertDialog.Builder(bienvenidadresponsable.this);
