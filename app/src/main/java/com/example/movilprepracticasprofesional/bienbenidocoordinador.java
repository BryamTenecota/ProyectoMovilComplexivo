...
public class bienbenidocoordinador extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView nombreTextView = headerView.findViewById(R.id.nameCoo);
        TextView apellidoTextView = headerView.findViewById(R.id.lastnameCoo);
        ...
        Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content), "¡Bienvenido entró como coordinador!", Snackbar.LENGTH_SHORT);
        ...
        switch (item.getItemId()){
            ...
            case R.id.nav_exit:
              /*  Toast.makeText(this, "Logout", Toast.LENGTH_SHORT).show();
                ...
                break;*/
                Toast.makeText(bienbenidocoordinador.this, "", Toast.LENGTH_SHORT).show();

                AlertDialog.Builder builder = new AlertDialog.Builder(bienbenidocoordinador.this);
